...
const servers = [{
  ...
  url: resolvePath('/images/servers/primarycare-app.webp'),
  category: "health",
  ...
  name: "Music.rodeo",
  url: resolvePath('/images/servers/music-rodeo.webp'),
  category: "music",
  description: "The GI server is for all music fans! Feel your heart beat! GroupIncome Server."
}, {
  name: "Climatejustice.social",
  url: resolvePath('/images/servers/climate-justice.webp'),
  category: "music",
