...
<div class="grid">
  <div class="grid-item" v-for="server in servers" :key="server.name">
    <div class="card">
      <div class="card-body">
        <img :src="server.url" class="card-img-top" :alt="server.name">
...
const servers = [{
  ...
  url:'/groupincome.org/images/servers/primarycare-app.webp',
  category: "health",
  ...
  name: "Music.rodeo",
  url:'/groupincome.org/images/servers/music-rodeo.webp',
  category: "music",
  description: "The GI server is for all music fans! Feel your heart beat! GroupIncome Server."
}, {
  name: "Climatejustice.social",
  url:'/groupincome.org/images/servers/climate-justice.webp',
  category: "music",
