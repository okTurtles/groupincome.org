<template>
<div id="servers" class="grid scroll-to-by-anchor">
  ...
  <div class="grid-item">
    <div class="card">
      ...
      <a class="button is-primary" href="https://github.com/okTurtles/groupincome.org/edit/master/src/components/Servers.vue">Get started</a>
    </div>
  </div>
</div>
</template>
