...
- Register 8 groups to run live tests with the Group Income prototype <a href={resolvePath('/posts/group-income-july-progress-update')}>as planned</a>.
