...
permalink: /posts/bulgaria-hackathon-2019-roadmap-updates-hiring/
categories:
    - Uncategorized
---
...
- A fully fleshed out and functioning proposals system. Voting is a topic we've spent a <a href={resolvePath('/posts/what-makes-a-good-voting-system')}>significant</a> <a href={resolvePath('/posts/misconceptions-about-majority-rule')}>amount of time</a> <a href={resolvePath('/posts/deprecating-mays-theorem')}>covering</a> on this blog.
