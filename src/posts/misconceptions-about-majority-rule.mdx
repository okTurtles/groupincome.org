...
permalink: /posts/misconceptions-about-majority-rule/
categories:
    - Uncategorized
tags:
    - voting
...
In our <a href={resolvePath('/posts/what-makes-a-good-voting-system')}>previous post</a>, we explored the meaning of voting and what it takes to make a good voting system. In this _Part 2_, we hope to convince you that what you've been told about [majority rule](https://en.wikipedia.org/wiki/Majority_rule) is not only untrue, but harmful.
...
Our <a href={resolvePath('/posts/what-makes-a-good-voting-system')}>previous post</a> explains why $D=0$ does not (typically) mean "indifference" but is indicative of disagreement:
